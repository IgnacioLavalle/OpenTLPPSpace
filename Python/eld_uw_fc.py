...
def parse_args():
    ...
    parser.add_argument("--beta", type=float, default=1.0, help="Alpha value (default: 2.0)")
    parser.add_argument("--win_size", type=int, default=4, help="Window size of historical snapshots (default: 2)")
...
def main():
    ...
    if save_metrics:
        ...
        filename = f"eld_uw_fc_curve_metrics_from_year{start_test}.json"
