...
def parse_args():
    ...
    parser.add_argument("--num_epochs", type=int, default=455, help="Number of training epochs (default: 500)")
...
def main():
    ...
    if save_metrics:
        ...
        filename = f"d2v_fc_curve_metrics_from_year{start_test}.json"
